...
class DataArguments:
    ...
    use_tags: bool = field(default=True, metadata={"help": "whether to tag the dataset or not"})
...
class SupervisedDataset(Dataset):
    ...
    def __init__(
        ...
        # data_dict should contain input_ids, labels, noise_fn_kwargs
        ...
        #self.noise_fn_kwargs = data_dict["noise_fn_kwargs"]
        #self.noise_fn_kwargs = data_dict.get("noise_fn_kwargs", None)
...
def train() -> None:
    ...
    print(f"Training model... use_tags: {data_args.use_tags}")
